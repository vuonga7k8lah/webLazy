                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?=\webLazy\Model\DashboardModel::productSold()['soDH'];?></div>
                                    <div>Product Sold</div>
                                </div>
                            </div>
                        </div>
                        <a href="<?=\webLazy\Core\URL::uri('listOrderAdmin')?>">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?=\webLazy\Model\DashboardModel::countProduct()['So_SP'];?></div>
                                    <div>Number Product</div>
                                </div>
                            </div>
                        </div>
                        <a href="<?=\webLazy\Core\URL::uri('listProduct')?>">
                            <div class="panel-footer">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?=\webLazy\Model\DashboardModel::countUser()['SoKH'];?></div>
                                    <div>Sum User</div>
                                </div>
                            </div>
                        </div>
                        <a href="<?=\webLazy\Core\URL::uri('listUser')?>">
                            <div class="panel-footer">
