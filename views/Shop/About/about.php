            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-10">
                    <div class="about-image-wrap">
                        <img class="img-full" src="./assets/upload/vuongkma.png" alt="About Us" />
                    </div>
                </div>
                <!-- About Image End -->
            </div>
            ...
            <div class="row no-gutters">
                    ...
                    <div class="limupa-counter white-smoke-bg">
                        <div class="container">
                            <div class="counter-img">
                                <img src="./assets/theme/images/about-us/icon/1.png" alt="">
                            </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="limupa-counter gray-bg">
                        <div class="counter-img">
                            <img src="./assets/theme/images/about-us/icon/2.png" alt="">
                        </div>
                        <div class="counter-info">
                            <div class="counter-number">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="limupa-counter white-smoke-bg">
                        <div class="counter-img">
                            <img src="./assets/theme/images/about-us/icon/3.png" alt="">
                        </div>
                        <div class="counter-info">
                            <div class="counter-number">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="limupa-counter gray-bg">
                        <div class="counter-img">
                            <img src="./assets/theme/images/about-us/icon/4.png" alt="">
                        </div>
                        <div class="counter-info">
                            <div class="counter-number">
                                <h3 class="counter">2169</h3>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-member mb-60 mb-sm-30 mb-xs-30">
                        <div class="team-thumb">
                            <img src="./assets/upload/think.gif" alt="Our Team Member" style="width: 270px;height: 290px">
                        </div>
                        <div class="team-content text-center">
                            <h3>Lê Hùng Vương</h3>
                            <p>Web Developer</p>
                            <a href="#">vuonga7k8lah@gmail.com</a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-member mb-60 mb-sm-30 mb-xs-30">
                        <div class="team-thumb">
                            <img src="./assets/upload/YUAmi.jpg" alt="Our Team Member" style="width: 270px;height: 290px">
                        </div>
                        <div class="team-content text-center">
                            <h3>Mikami Yua</h3>
                            <p>Web Designer</p>
                            <a href="#">yuamikamiJAV@gmail.com</a>
                            <div class="team-social">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
                                <a href="#"><i class="fa fa-linkedin"></i></a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-member mb-30 mb-sm-60">
                        <div class="team-thumb">
                            <img src="./assets/theme/images/team/3.png" alt="Our Team Member" style="width: 270px;height: 290px">
                        </div>
                        <div class="team-content text-center">
                            <h3>Erik Jonson</h3>
                            <p>Web Developer</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-member mb-30 mb-sm-60 mb-xs-60">
                        <div class="team-thumb">
                            <img src="./assets/theme/images/team/4.png" alt="Our Team Member" style="width: 270px;height: 290px">
                        </div>
                        <div class="team-content text-center">
                            <h3>Maria Mandy</h3>
