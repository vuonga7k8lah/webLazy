<?php
$idTheLoai = \webLazy\Core\Request::uri()[1];
$aDataLT = \webLazy\Model\SearchModel::returnIdTheLoai($idTheLoai);
$row = \webLazy\Model\SearchModel::searchTypeBlog($aDataLT['idLoaiTin']);
...
?>
    ...
    <div style="text-align: center"><h2>Các Bài Viết Thuộc Danh Mục : <?= $aDataLT['TenTheLoai'] ?></h2></div>
