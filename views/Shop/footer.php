            ...
            <div class="footer-shipping pt-60 pb-55 pb-xs-25">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="./assets/theme/images/shipping-icon/1.png" alt="Shipping Icon">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="./assets/theme/images/shipping-icon/2.png" alt="Shipping Icon">
                            </div>
                            <div class="shipping-text">
                                <h2>Safe Payment</h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="./assets/theme/images/shipping-icon/3.png" alt="Shipping Icon">
                            </div>
                            <div class="shipping-text">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="./assets/theme/images/shipping-icon/4.png" alt="Shipping Icon">
                            </div>
                            <div class="shipping-text">
            ...
            <div class="footer-logo-wrap pt-50 pb-35">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6" style="margin-top: 25px;">
                        <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FShop-Money-104049854867927&tabs&width=340px&height=300px&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=3121237121303891"
                                width="340px" height="300px" style="border:none;overflow:hidden" scrolling="no"
...
<!-- Ajax Mail js -->
<script src="./assets/theme/js/ajax-mail.js"></script>
<!-- Meanmenu js -->
<script src="./assets/theme/js/jquery.meanmenu.min.js"></script>
<!-- Wow.min js -->
...
<!-- Barrating -->
<script src="./assets/theme/js/jquery.barrating.min.js"></script>
<!-- Jquery-ui -->
<script src="./assets/theme/js/jquery-ui.min.js"></script>
<!-- Venobox -->
<script src="./assets/theme/js/venobox.min.js"></script>
<!-- Nice Select js -->
