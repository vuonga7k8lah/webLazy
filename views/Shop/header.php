                    ...
                    <div class="col-lg-3">
                        <div class="logo pb-sm-30 pb-xs-30">
                            <a href="<?=\webLazy\Core\URL::uri('home')?>">
                                <img src="./assets/theme/images/menu/logo/1.jpg" alt="">
                            </a>
                        </div>
                    </div>
                                ...
                                <li class="hm-minicart">
                                    ...
                                    <div class="minicart">
                                        <ul class="minicart-product-list">
                                            ...
                                            <li>
                                                <a href="single-product.html" class="minicart-product-image">
                                                    <img src="./assets/theme/images/product/small-size/6.jpg" alt="cart products">
                                                </a>
                                                <div class="minicart-product-details">
                                                    <h6><a href="single-product.html">Aenean eu tristique</a></h6>
                                                    <span>£40 x 1</span>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="hb-menu">
                            <nav>
                                <ul>
                                    <li class="dropdown-holder"><a href="<?=\webLazy\Core\URL::uri('home')?>">Home</a>
