    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8">
                <div class="slider-area">
                    <div class="slider-active owl-carousel">
                        ...
                        <?php
                        $row=\webLazy\Model\BannerModel::selectAll();
                        foreach ($row as $value):
                            if($value[2]=='TRUE'){
                            ?>
                        <div class="single-slide align-center-left  animation-style-01 bg-1" >
                            <div class="slider-progress">
                                <img src="./assets/upload/Banner/<?=$value[3]?>" alt="" style="min-height: 475px;width: 100%;">
                            </div>
                        </div>
                        <?php }
                            endforeach; ?>
            ...
            <div class="col-lg-4 col-md-4 text-center pt-xs-30">
                <div class="li-banner">
                    <a href="#">
                        <img src="./assets/theme/images/banner/1_1.jpg" alt="">
                    </a>
                </div>
                <div class="li-banner mt-15 mt-sm-30 mt-xs-30">
                    <a href="#">
                        <img src="./assets/theme/images/banner/1_2.jpg" alt="">
                    </a>
                </div>
            </div>
